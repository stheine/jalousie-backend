...
const getData = async function(params) {
  ...
  check.assert.equal(data.name.trim(), params.config.openWeatherLocation.city,
    `Weather data city mismatch '${data.name}!==${params.config.openWeatherLocation.city}'`);
  check.assert.equal(data.id, params.config.openWeatherLocation.cityId,
    `Weather data id mismatch '${data.id}!==${params.config.openWeatherLocation.cityId}'`);
