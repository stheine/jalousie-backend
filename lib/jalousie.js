...
//    if(currentTime.second() === 30 || temperatureDht === undefined
      if(currentTime.second() === 30 || currentTime.second() === 40 ||
         currentTime.second() === 50 || currentTime.second() === 10 ||
         currentTime.second() === 20 || temperatureDht === undefined
      ) {
//           logDebug('get dht22');
// this is the c implementation:
//   asyncFunctions.dht22 = pigpiod.dht22(globals.pi, 18);
// this is the js implementation
//   asyncFunctions.dht22 = pigpiod.dht(globals.pi, 18);
...
//          logDebug('dht22 data received');
      ...
      sun.getThreshold(globals.pi).then(newSunThreshold => {
      ...
      kty81.getTemperature(globals.pi).then(newKty81Temperature => {
