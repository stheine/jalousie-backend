...
app.get('/ganzhochclick', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_GANZHOCH);
    res.send('ok');
  }
});
...
app.get('/ganzrunterclick', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_GANZRUNTER);
    res.send('ok');
  }
});
...
app.get('/schattenclick', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_SCHATTEN);
    res.send('ok');
  }
});
...
app.get('/wendungclick', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_WENDUNG);
    res.send('ok');
  }
});
...
app.get('/allehoch', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_ALLE_HOCH);
    res.send('ok');
  }
});
...
app.get('/allerunter', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_ALLE_RUNTER);
    res.send('ok');
  }
});
...
app.get('/individuell', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_INDIVIDUELL);
    res.send('ok');
  }
});
...
app.get('/sonder', (req, res) => {
  if(flagWindalarm) {
    ...
    // Start new thread.
    actionThread = new Action(JALOUSIE_SONDER_TEST);
    res.send('ok');
  }
});
