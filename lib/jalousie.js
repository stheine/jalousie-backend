...
// TODO TODO TODO DHT sensor only works sometimes...
// try if I could put it into a separate promise, not executed
// parallel to the others, but serial...
...
//  logDebug('Start main loop');
  ...
  new Promise(resolve => {
    ...
    } else if(currentTime.second() === 30 || temperatureDht === undefined) {
