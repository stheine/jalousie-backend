        ...
        case 'JALOUSIE_SCHATTEN':
          {
            ...
            if(this.config.sonneRunterPosition > 3) {
              timeout = this.config.sonneRunterPosition - 3;
            } else {
              timeout = 0;
            }
            ...
            tasks = [
              ...
              this.log(
                ...
                `${this.config.sonneRunterWendung}ms, AUS`),
              this.gpioWrite(this.gpio.up, JALOUSIE_AN),
              this.delay(this.config.sonneRunterWendung),
              this.gpioWrite(this.gpio.up, JALOUSIE_AUS),
              this.log(
