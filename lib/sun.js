...
const getSunThreshold = function (pi, spiChannel, mcpChannel) {
  return new Promise((resolve, reject) => {
    let   sunThreshold;
    const nowTicks     = pigpiod.get_current_tick(pi);
    const a2dValue     = pigpiod.mcp3204(pi, spiChannel, mcpChannel);
...
// TODO    writeStatus("sunThreshold", FMT_INT_02, (void *)&sunThreshold);
// TODO    writeStatus("sonneA2Dval",    FMT_FLOAT_04_0, (void *)&averageA2dValue);
